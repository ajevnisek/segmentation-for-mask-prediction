...
class MaskModel(pl.LightningModule):
    ...
    def __init__(self, arch, encoder_name, in_channels, out_classes,
                 optimizer_type, learning_rate, **kwargs):
        super().__init__()
    ...
    def shared_step(self, batch, stage):
        ...
        # encoder have 5 stages of
        # downsampling by factor 2 (2 ^ 5 = 32); e.g. if we have image with
        # shape 65x65 we will have
        # following shapes of features in encoder and decoder: 84, 42, 21,
        # 10, 5 -> 5, 10, 20, 40, 80
        ...
        # Check that mask values in between 0 and 1, NOT 0 and 255 for binary
        # segmentation
    ...
    def configure_optimizers(self):
        return {'Adam': torch.optim.Adam(self.parameters(),
